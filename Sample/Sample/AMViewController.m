...
- (void)shake
{
    ...
    shakeDirection:(self.shakeDirection.selectedSegmentIndex == 0) ? ShakeDirectionHorizontal : ((self.shakeDirection.selectedSegmentIndex == 1) ? ShakeDirectionVertical : ShakeDirectionRotation)
        completion:^{
            NSLog(@"done!");
        }];
    }];
